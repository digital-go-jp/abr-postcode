...
# - Native API Key authentication with Usage Plans
# - API Key stored in Secrets Manager for retrieval
# - CloudWatch Logs role configured at account level
# - Method-level logging enabled
# - GET / OPTIONS supported (abrp serves GET only)
...
# Method Settings (log_level, metrics)
