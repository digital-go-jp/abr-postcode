...
func (d *AddressData) addTown(town model.Town) {
	d.Towns[town.LgCode+town.MachiazaID] = town
}
...
func (d *AddressData) addPostCodeMapping(mapping model.PostCodeMapping) {
	...
	townKey := mapping.LgCode + mapping.MachiazaID
	d.TownToPostCodes[townKey] = append(d.TownToPostCodes[townKey], mapping.PostCode)
}
